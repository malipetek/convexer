...
function parseImageRollbackRef (raw: string | null | undefined): ImageRollbackRef | null
{
...
async function reconcileImageUpdateResult (jobId: string): Promise<void>
{
  try {
...
async function reconcileLatestImageUpdateResult (): Promise<void>
{
